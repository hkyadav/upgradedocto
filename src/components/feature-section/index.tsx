    ...
    <div className={tw(`max-w-7xl mx-auto p-4 sm:p-6 lg:p-8`)}>
      <div className={tw(`container mx-auto px-6 p-6 bg-white`)}>
        <div className={tw(`mb-16 text-center`)}>
          <h4 className={tw(`text-base text-fuchsia font-semibold tracking-wide uppercase`)}>facilities</h4>
        ...
        <div className={tw(`flex flex-wrap my-12`)}>
          <div className={tw(`w-full border-b md:w-1/2 md:border-r lg:w-1/3 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              ...
              <div className={tw(`ml-4 text-xl text-fuchsia`)}>Premium Facility</div>
            </div>
          ...
          <div className={tw(`w-full border-b md:w-1/2 lg:w-1/3 lg:border-r p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              ...
              <div className={tw(`ml-4 text-xl text-fuchsia`)}>Great Destinations</div>
            </div>
            <p className={tw(`leading-loose text-gray-500 `)}>
          ...
          <div className={tw(`w-full border-b md:w-1/2 md:border-r lg:w-1/3 lg:border-r-0 p-8`)}>
            <div className="flex items-center mb-6">
              ...
              <div className={tw(`ml-4 text-xl text-fuchsia`)}>Bar & Lounge</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
          ...
          <div className={tw(`w-full border-b md:w-1/2 lg:w-1/3 lg:border-r lg:border-b-0 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              ...
              <div className={tw(`ml-4 text-xl text-fuchsia`)}>Sea Diving</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
          ...
          <div className={tw(`w-full border-b md:w-1/2 md:border-r md:border-b-0 lg:w-1/3 lg:border-b-0 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              ...
              <div className={tw(`ml-4 text-xl text-fuchsia`)}>Book Now & Pay Later*</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
          ...
          <div className={tw(`w-full md:w-1/2 lg:w-1/3 p-8`)}>
            <div className={tw(`flex items-center mb-6`)}>
              ...
              <div className={tw(`ml-4 text-xl text-fuchsia`)}>Kids Sail Free*</div>
            </div>
            <p className={tw(`leading-loose text-gray-500`)}>
